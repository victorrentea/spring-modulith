...
import victor.training.modulith.order.UrlPaymentGeneratorPort;
...
public class PlaceOrderApi {
  ...
  private final UrlPaymentGeneratorPort urlPaymentGeneratorPort;
  ...
  public String placeOrder(@RequestBody @Validated PlaceOrderRequest request) {
    ...
    return urlPaymentGeneratorPort.generatePaymentUrl(order.id(), order.total());
  }
