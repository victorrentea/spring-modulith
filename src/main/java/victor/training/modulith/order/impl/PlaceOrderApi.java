...
import victor.training.modulith.order.IPaymentProviderSPI;
...
public class PlaceOrderApi {
  ...
  private final IPaymentProviderSPI IPaymentProviderSPI;
  ...
  public String placeOrder(@RequestBody @Validated PlaceOrderRequest request) {
    ...
    return IPaymentProviderSPI.generatePaymentUrl(order.id(), order.total());
  }
