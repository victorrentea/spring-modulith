...
import victor.training.modulith.order.PaymentUrlGeneratorPort;
...
public class PlaceOrderApi {
  ...
  private final PaymentUrlGeneratorPort paymentUrlGeneratorPort;
  ...
  public String call(@RequestBody @Validated PlaceOrderRequest request) {
    ...
    return paymentUrlGeneratorPort.generatePaymentUrl(order.id(), order.total());
  }
